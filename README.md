...
<script src="https://unpkg.com/onfmready.js@2.1.0/dist/onfmready.min.js"></script>

<!-- With Support for Microsoft Internet Explorer 11 -->
<script src="https://unpkg.com/onfmready.js@2.1.0/dist/onfmready.es5.min.js"></script>
```
> :pencil: **NOTE:** Versioning
>
> It is recommended that you pin a version number (shown as `@2.1.0`) to prevent the introduction of potentially-breaking changes when updates are made to OnFMReady.
